...
class KSeF_XML_Builder {
    ...
    private function append_fa(
        ...
        // Cloned (pre-correction) product state — needed for the "before"
        // FaWiersz rows appended further down.
        ...
        // Header totals always reflect the full current invoice state only —
        // KSeF recomputes P_13-P_15 itself from FaWiersz anyway, and diffing
        // "before" into our own declared totals previously caused it to double
        // the amount rather than net it. "Before" rows exist below purely to
        // satisfy KSeF's product-table validation for a corrective invoice.
